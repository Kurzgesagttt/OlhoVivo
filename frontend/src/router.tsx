...
import ClosedOccurrencesPage from './pages/admin/ClosedOccurrencesPage'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/encerradas" element={<ProtectedRoute roles={[...ADMIN_ROLES]}><ClosedOccurrencesPage /></ProtectedRoute>} />
